...
<!-- <script src="/final/js/member/myinfo_kakao.js"></script> -->
			...
			<div class="member-myinfo-content-wrap">
				<div class="member-myinfo-content-cont">
					<c:choose>
					    ...
					    <c:otherwise>
							 <div class="member-myinfo-content-wrap2">
								<div class="member-myinfo-content-cont">
									<div class="member-view-wrapper">
									
										<div class="member-view-wrapper-item1 item-detail">
										<label class="member-view-label label-email">KaKaoEmail</label>
											<input name="kakao-email" class="nfTextField " id="kakao-email" type="email" autocomplete="off" placeholder="Email" value="">
										</div>
										
										<div class="member-view-wrapper-item2 item-detail">
											<label class="member-view-label label-email">Name</label>
											<input autocomplete="off" type="text" id="kakao-name" class="nfTextField" name="kakao-name" placeholder="Name" value="">
										</div>
										
										<div class="member-view-wrapper-item3 item-detail">	</div>
										
										<div class="member-view-wrapper-item4 item-detail">
											<label class="member-view-label label-email">KaKaoNickName</label>
											<input autocomplete="off" type="text" id="kakao-nickname" class="nfTextField" name="kakao-nickname" placeholder="NickName" value="${bomNickName}" onfocus="javascript:blur();" style="cursor:default;">
										</div>
										...
										<div class="member-view-wrapper-item6 item-detail">
											<label class="member-view-label label-email">Date Of Birth</label>
											<input autocomplete="off" type="date" id="kakao-date" class="nfTextField" name="kakao-date">
										</div>
										...
										<div class="member-view-wrapper-item8 item-detail">
											<label class="member-view-label label-email">Phone</label>
											<input autocomplete="off" type="text" id="kakao-phone" class="nfTextField" name="kakao-phone" placeholder="phone" value="">
										</div>
										
										<div class="member-view-wrapper-item9"></div>
										
										<div class="member-view-wrapper-item10">
											<input value="개인정보 수정" autocomplete="off" type="button" id="member-view-btn-delete" class="btn btn-secondary member-view-delete" onclick="kakaoModify()">
										</div>
										
										<div class="member-view-wrapper-item11 item-detail item-delete">
							    			<a href="#">개인정보를 삭제</a> 하기를 원하십니까?</div>
									</div>
									<input type="hidden" id="kakao-id" value="${bomLoginId}">
								</div>
							</div>     
					    </c:otherwise>
					</c:choose>				
...
document.getElementById('kakao-date').value = new Date().toISOString().substring(0, 10);
$('.member-myinfo-content-wrap').ready(function(){
	myinfoChange();
	
});
$('.member-myinfo-content-wrap2').ready(function(){
	myinfoChange2();
